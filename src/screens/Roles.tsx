        ...
        <CardContent>
          {roles.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground">No roles defined. The admin role has full access by default.</p>
            </div>
          ) : (
              ...
              {roles.map((r) => (
                <div key={r.name} className="border border-border rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-xs text-muted-foreground mb-1.5 uppercase tracking-wider">Can Open</p>
                    ...
                    <div>
                      <p className="text-xs text-muted-foreground mb-1.5 uppercase tracking-wider">Can Write</p>
                      <div className="flex flex-wrap gap-1">
